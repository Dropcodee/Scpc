...
<body>
        ...
        <nav class="navbar navbar-default bootsnav navbar-top bg-transparent header-dark white-link">
            <div class="container-fluid nav-header-container height-85px padding-three-half-lr xs-height-70px xs-padding-15px-lr">
                ...
                ?>
                                                            ...
                                                            <input type="text" name="stud_id" id="stud_id" placeholder="Registration Number" class="input border-color-medium-dark-grey bg-transparent " autocomplete="off">
                                                            <span class="form-control-feedback"></span> </div>
                                                            <div class="form-group has-warning has-feedback">

                                                            <input type="password" name="password" id="password" class="medium-input border-color-medium-dark-grey bg-transparent" placeholder="Password" autocomplete="off"><span class="glyphicon glyphicon-key"></span> </div>
                                                            <br /> Forgot Password ?
                                                            <a href="changepwd.php"> Change Password </a>
                                                            <button type="submit" name="submit" class=" btn btn-deep-pink btn-rounded btn-medium margin-20px-top margin-10px-bottom next2"
                                                                value="Login" >Login</button> &nbsp;
                                                            <br /> Dont have an account ?
                                                            <a href="registration.php">SIGN UP </a></form>
                                                        </fieldset>
                        ...
                        <div class="slider-typography text-center">
                            <div class="slider-text-middle-main">
                                <div class="slider-text-middle">
                                    ...
                                    <div class="btn-dual">
                                        <a href="maintenance.html" target="_blank" class="btn btn-transparent-white btn-small xs-margin-two-all">Tent Booking</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="slider-typography text-center">
                            <div class="slider-text-middle-main">
                                <div class="slider-text-middle">
                                    ...
                                    <div class="alt-font text-white text-uppercase font-weight-700 letter-spacing-minus-3 title-extra-large margin-two-bottom width-60 center-col md-width-80 sm-margin-four-bottom xs-width-90 xs-margin-25px-bottom xs-letter-spacing-0">CLASS '18</div>
                                    <div class="btn-dual">
                                        <a href="maintenance.html" target="_blank" class="btn btn-transparent-white btn-small xs-margin-two-all">Hotel Booking</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row equalize xs-equalize-auto wow fadeInUp">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12 sm-margin-four-bottom xs-margin-30px-bottom last-paragraph-no-margin wow wobble">
                    <div class="feature-box">
                        <div class="content">
                            <a href="maintenance.html" <i class="icon-pricetags text-medium-gray icon-large margin-25px-bottom sm-margin-15px-bottom">
                                </i>
                            </a>
                ...
                <div class="col-md-3 col-sm-4 col-xs-12 sm-margin-four-bottom xs-margin-30px-bottom last-paragraph-no-margin wow wobble">
                    <div class="feature-box">
                        <div class="content">
                            <a href="maintenance.html" <i class="icon-wallet text-medium-gray icon-large margin-25px-bottom sm-margin-15px-bottom">
                                </i>
                            </a>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-7 col-sm-12 col-xs-12 center-col text-center margin-100px-bottom xs-margin-40px-bottom">
                <div class="position-relative overflow-hidden width-100">
                    <span class="text-small text-outside-line-full alt-font font-weight-600 text-uppercase">STAY INFORMED</span>
                </div>
            </div>
        </div>
        <div class="row equalize sm-equalize-auto">
                    ...
                    <div class="swiper-slide last-paragraph-no-margin">
                        <div class="padding-eighteen-all md-padding-eight-all xs-padding-15px-lr">
                            ...
                            <p class="width-90 xs-width-85 center-col">This is to inform the graduating students that they should start making all booking for hotels
                                and tents now, because the remaining tents and hotels will soon be taken please start booking
                                now, Remain ever blessed Thank You.</p>
                            <a href="maintenance.html" class="btn btn-small btn-white margin-35px-top">Hotel Booking</a>
                        </div>
                    </div>
                    <!-- end slider item -->
                </div>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12 cover-background sm-height-500px xs-height-350px wow fadeIn" style="background-image:url(images/grad4.jpg) !important; z-index: 2000000000 !important;">
            </div>
        </div>
    </div>
</section>
...
<section id="contact" class="wow fadeIn no-padding bg-extra-dark-gray">
        <div class="container-fluid">
            <div class="row equalize sm-equalize-auto">
                <div class="col-md-6 col-sm-12 col-xs-12 md-height-100% sm-height-550px xs-height-350px wow fadeIn">
                 <img class="sm-height-500px xs-height-350px bg-images" src="images/grad9.jpg" alt="" style="height:680px; width:100%; background-size: cover; background-position: left;">
            </div>
                ...
                <div class="row equalize xs-equalize-auto">
                    ...
                    <div class="col-md-3 col-sm-6 col-xs-12 widget border-right border-color-medium-dark-gray padding-45px-left sm-padding-15px-left sm-no-border-right sm-margin-30px-bottom xs-text-center">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <a class="text-small" href="maintenance.html">TENT BOOKING</a>
                            </li>
                            <li>
                                <a class="text-small" href="hmaintenance.html">HOTEL BOOKING</a>
                            </li>
                        </ul>
                    </div>
