    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            if(isset($_GET['id'])) {
                ...
                echo "<div class='alert alert-danger'>Are you sure you want to delete selected nominee? <a href='http://localhost/scpc/sandbox/delete_nominee.php?del_id=$nom_id'>Yes</a> | <a href='http://localhost/scpc/sandbox/add_nominees.php'>No</a></div>";
            }
