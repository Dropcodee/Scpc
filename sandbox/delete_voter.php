    ...
    <div class="row">
        <div class="col-md-4 col-md-offset-4">
            ...
            if(isset($_GET['id'])) {
                ...
                echo "<div class='alert alert-danger'>Are you sure you want to delete selected voter? <a href='http://localhost/scpc/sandbox/delete_voter.php?del_id=$voter_id'>Yes</a> | <a href='http://localhost/scpc/sandbox/add_voters.php'>No</a></div>";
            }
