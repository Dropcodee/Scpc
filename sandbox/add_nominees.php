            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered table-condensed table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="http://localhost/scpc/sandbox/edit_nominee.php?id=<?php echo $rowNom['id']; ?>"><span class="glyphicon glyphicon-edit"></span></a></td>
                        <td><a href="http://localhost/scpc/sandbox/delete_nominee.php?id=<?php echo $rowNom['id']; ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
                    </tr>
                    <?php } //End while ?>
                </table>
